...
require 'gerarRequestValidarBoleto.php';
require 'signatureValidaBoleto.php';

$curl = curl_init();

curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://proxy.api.prebanco.com.br/oapi/v1/pagamentos/boleto/validarDadosTitulo',
  ...
  CURLOPT_HTTPHEADER => array(
    ...
    'X-Brad-Signature: '.$boletoSignature,
    'X-Brad-Nonce: '.$jti,
